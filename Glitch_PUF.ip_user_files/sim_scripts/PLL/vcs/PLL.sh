...
#
# Generated by Vivado on Tue Oct 08 21:14:40 +0800 2019
...
# Script info
echo -e "PLL.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../Glitch_PUF.srcs/sources_1/new/LBlockUART/PUF/PLL/PLL_clk_wiz.v" \
    "$ref_dir/../../../../Glitch_PUF.srcs/sources_1/new/LBlockUART/PUF/PLL/PLL.v" \
  2>&1 | tee -a vlogan.log
