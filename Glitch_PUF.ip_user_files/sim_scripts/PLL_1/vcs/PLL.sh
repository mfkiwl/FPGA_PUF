...
#
# Generated by Vivado on Thu Mar 21 20:43:33 +0800 2019
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../Glitch_PUF.srcs/sources_1/ip/PLL_1/PLL_clk_wiz.v" \
    "$ref_dir/../../../../Glitch_PUF.srcs/sources_1/ip/PLL_1/PLL.v" \
  2>&1 | tee -a vlogan.log
