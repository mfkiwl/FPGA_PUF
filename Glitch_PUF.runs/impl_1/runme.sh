...
HD_PWD='C:/Users/admin/Desktop/FPGA_PUF/Glitch_PUF.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cmd_handler.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cmd_handler.tcl -notrace
