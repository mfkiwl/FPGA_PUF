...
HD_PWD='C:/Users/admin/Desktop/FPGA_PUF/Glitch_PUF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cmd_handler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cmd_handler.tcl
